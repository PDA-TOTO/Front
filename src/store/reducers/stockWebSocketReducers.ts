...
export const stockWebSocketSlice = createSlice({
    ...
    reducers: {
        pushWebsocketPrice: (state, action: PayloadAction<StockWebSocketInitialState>) => {
...
export const { pushWebsocketPrice, resetWebSocketState } = stockWebSocketSlice.actions;
