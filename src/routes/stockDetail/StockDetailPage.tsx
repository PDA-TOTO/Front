...
import { pushWebsocketPrice, resetWebSocketState } from '../../store/reducers/stockWebSocketReducers';
...
const StockDetailPage: React.FC = () => {
    ...
    const [latestChartData, setLatestChartData] = useState<chartData | null>(null);
    const [stockInfo, _] = useState<StockInfo>({
        price: 134900,
        percent: 12.9,
    });
