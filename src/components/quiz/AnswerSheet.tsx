...
export default function AnswerSheet({
    ...
    return (
        <Flex className={classes.page} justify="space-between" align="center" direction={'column'} bg={'secondary.5'}>
            ...
            >
                <Flex>
                    <Text w="120px" ta="center" fw="600">
                        전체 문제
                    </Text>
                    <Text color="gray.5">|</Text>
                    <Text w="50px" ta="center" fw="600">
                        {quiz.length}
                    </Text>
                </Flex>
                <Flex>
                    ...
                    <Text color="gray.5">|</Text>
                    <Text w="50px" ta="center" fw="600">
                        {quiz.length - isSolved.filter((v) => v).length}
                    </Text>
                </Flex>
                <Flex>
                    <Text w="120px" ta="center" fw="600">
