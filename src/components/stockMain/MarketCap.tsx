...
export default function MarketCap({}: Props) {
    ...
    return (
        <Flex direction={'column'}>
                                    ...
                                    <Flex direction={'column'}>
                                        ...
                                        <div className={classes.grid_card_price}>
                                            <Flex direction={'row'} justify="flex-end" align="flex-end">
                                                ...
                                                <Flex justify="flex-end" align="flex-end" className={classes.billion}>
                                                    (억)
                                                </Flex>
                                            </Flex>
                                            <div className={classes.grid_card_percent}>{value.yymm}</div>
                                        </div>
                                    </Flex>
            ...
            <Flex gap="md" justify={{ md: 'center' }} style={{ paddingTop: '40px', cursor: 'pointer' }}>
