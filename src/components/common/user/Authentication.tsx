    ...
    <>
      <form
        ...
        onSubmit={form.onSubmit(() =>
          sendToServer(form.values.email, form.values.password)
        )}
      >
        <Stack>
          ...
          <TextInput
            ...
            radius="12px"
            styles={{
              input: { height: "60px", width: "360px", fontSize: "16px" },
          ...
          <PasswordInput
            ...
            error={
              (form.errors.password === "length" &&
                "비밀번호는 6자리 이상 입력하십시오.") ||
              (form.errors.password === "combination" &&
                "비밀번호는 숫자와 문자를 조합하여 사용해야합니다.")
            }
            radius="12px"
            styles={{
              input: { height: "60px", width: "360px", fontSize: "16px" },
        ...
        <Flex direction="column" justify="space-between" mt="xl">
          ...
          <Anchor
            ...
            c="dimmed"
            onClick={() => {
              type === "회원가입" ? navigate("/login") : navigate("/signup");
            }}
            size="xs"
            p="md"
            style={{ fontSize: "16px" }}
