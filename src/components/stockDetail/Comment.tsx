...
export default function Comment({
    ...
    return (
        ...
        >
            <Avatar variant="filled" radius="xl" color="secondary.5" className={classes.cmt_avatar} />
            <Flex direction={'column'} gap={20} style={{ width: '100%' }}>
                <Flex direction={'row'} gap={10} align="center">
                    ...
                    <div className={classes.cmt_time}>{calculateTimeDifference(createdAt)}</div>
                    {writerVoteType === 'LIKE' ? (
                ...
                <Flex style={{ width: '100%' }} justify="flex-end">
                    <Flex direction={'row'} align="center">
                        <div className={classes.cmt_like_div} onClick={onLikeClick} style={{ cursor: 'pointer' }}>
                            {isLiked === 'LIKE' ? (
